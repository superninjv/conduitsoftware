      ...
      <div className="max-w-6xl mx-auto px-6 py-14">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          ...
          {footerLinks.map((group) => (
            <div key={group.title}>
              <h4 className="font-display font-medium text-xs text-[var(--text-tertiary)] uppercase tracking-wider mb-4">
                {group.title}
              </h4>
        ...
        <div className="mt-12 pt-6 border-t border-[var(--border-color)] flex flex-col sm:flex-row justify-between items-center gap-3">
